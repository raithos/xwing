...
exportObj.cardLoaders.Deutsch = () ->
    ...
    pilot_translations =
        ...
        "Alpha Squadron Pilot":
           ...
           text: <strong>Automatische Schubdüsen:</strong> Nachdem du eine Aktion durchgeführt hast, darfst du eine rote %BARRELROLL%-Aktion oder eine rote %BOOST%-Aktion durchführen."""
        "Arvel Crynyd":
        ...
        "Autopilot Drone":
           ...
           # ship: """Fluchtschiff"""
           text: <strong>Manipulierte Energiezellen:</strong> Während der Systemphase, falls du nicht angedockt bist, verliere 1&nbsp;%CHARGE%. Am Ende der Aktivierungsphase, falls du 0 %CHARGE% hast, wirst du zerstört. Bevor du entfernt wirst, erleidet jedes Schiff in Reichweite 0-1 1&nbsp;%CRIT%-Schaden."""
        ...
        "Black Squadron Scout":
           ...
           # ship: """TIE/sk-Stürmer"""
           text:  <strong>Adaptive Querruder:</strong> Bevor du dein Rad aufdeckst, falls du nicht gestresst bist, <b>musst</b> du ein weißes [1&nbsp;%BANKLEFT%]-, [1&nbsp;%STRAIGHT%]- oder [1&nbsp;%BANKRIGHT%]-Manöver ausführen."""
        "Black Sun Ace":
        ...
        "Black Sun Assassin":
           ...
           text: <strong>Mikrodüsen:</strong> Solange du eine Fassrolle durchführst, <b>musst</b> du die %BANKLEFT%- oder %BANKRIGHT%-Schablone anstatt der %STRAIGHT%-Schablone verwenden."""
        "Black Sun Enforcer":
        ...
        "Cartel Executioner":
           ...
           text:  <strong>Todsicherer Treffer:</strong> Solange du einen Angriff durchführst, falls der Verteidiger in deinem %BULLSEYEARC% ist, können Verteidigungswürfel nicht unter Verwendung von grünen Markern modifiziert werden."""
        "Cartel Marauder":
        ...
        "Cartel Spacer":
           ...
           text: <strong>Waffenaufhängung:</strong> Du kannst 1&nbsp;%CANNON%-,&nbsp;%TORPEDO%- oder %MISSILE%-Aufwertung ausrüsten."""
        "Cassian Andor":
...
"""
        ...
        "Delta Squadron Pilot":
           ...
           # ship: """TIE/D-Abwehrjäger"""
           text: <strong>Vollgas:</strong> Nachdem du ein Manöver mit Geschwindigkeit 3-5 vollständig ausgeführt hast, darfst du eine %EVADE%-Aktion durchführen."""
        "Dengar":
           display_name: """Dengar"""
           # ship: """JumpMaster 5000"""
        ...
        "Gamma Squadron Ace":
           ...
           # ship: """TIE/sa-Bomber"""
           text: <strong>Wendiger Bomber:</strong> Falls du unter Verwendung einer %STRAIGHT%-Schablone ein Gerät abwerfen würdest, darfst du stattdessen eine %BANKLEFT%- oder %BANKRIGHT%-Schablone derselben Geschwindigkeit verwenden."""
        "Gand Findsman":
        ...
        "Green Squadron Pilot":
           ...
           # ship: """RZ-1-A-Flügler"""
           text: <strong>Schwenkbare Schubdüsen:</strong> Nachdem du eine Aktion durchgeführt hast, darfst du eine rote %BOOST%-Aktion durchführen."""
        "Guri":
           display_name: """Guri"""
           # ship: """Angriffsplattform der Sternenviper-Klasse"""
        ...
        "Imdaar Test Pilot":
           ...
           # ship: """TIE/ph-Phantom"""
           text: <strong>Stygium-Gitter:</strong> Nachdem du dich enttarnt hast, darfst du eine %EVADE%-Aktion durchführen. Zu Beginn der Endphase darfst du 1 Ausweichmarker ausgeben, um 1 Tarnungsmarker zu erhalten."""
        "Inaldra":
        ...
        "Jakku Gunrunner":
           ...
           # ship: """Quadrijet-Transferschlepper"""
           text: <strong>Schlepperstrahl:</strong> <strong>Aktion:</strong> Wähle ein Schiff in deinem %FRONTARC% in Reichweite 1. Jenes Schiff erhält 1 Fangstrahlmarker oder 2&nbsp;Fangstrahlmarker, falls es in deinem %BULLSEYEARC%&nbsp;in Reichweite 1 ist."""
        "Jan Ors":
        ...
        "Knave Squadron Escort":
           ...
           # ship: """E-Flügler"""
           text:  <strong>Experimentelle Scanner:</strong> Du kannst Ziele jenseits von Reichweite 3 erfassen. Du kannst keine Ziele in Reichweite 1 erfassen."""
        "Koshka Frost":
        ...
        "Lothal Rebel":
           ...
           # ship: """Leichter VCX-100-Frachter"""
           text: <strong>Heckgeschütz:</strong> Solange du ein angedocktes Schiff hast, hast du eine %REARARC%-Primärwaffe mit einem Angriffswert in Höhe des Angriffswertes der %FRONTARC%-Primärwaffe deines angedockten Schiffes."""
        "Lowhhrick":
        ...
        "Skull Squadron Pilot":
           ...
           # ship: """Fangjäger"""
           text:  <strong>Concordianischer Wirbel:</strong> Solange du verteidigst, falls die Angriffsreichweite 1 ist und du im %FRONTARC% des Angreifers bist, ändere 1&nbsp;Ergebnis in ein %EVADE%-Ergebnis."""
        "Sol Sixxa":
        ...
        "Storm Squadron Ace":
           ...
           # ship: """TIE-x1-Turbojäger"""
           text: <strong>Verbesserter Zielcomputer:</strong> Solange du einen Primärangriff gegen einen Verteidiger durchführst, den du als Ziel erfasst hast, wirf 1 zusätzlichen Angriffswürfel und ändere 1&nbsp;%HIT%-Ergebnis in ein %CRIT%-Ergebnis."""
        "Sunny Bounder":
        ...
        "Wild Space Fringer":
           ...
           # ship: """Leichter YT-2400-Frachter"""
           text: <strong>Toter Winkel:</strong> Solange du einen Primärangriff in Reichweite 0-1 durchführst, wende den Bonus für Reichweite 0-1 nicht an und wirf 1 Angriffswürfel weniger."""
        "Wullffwarro":
    ...
    upgrade_translations =
        ...
        "Expert Handling":
           ...
           text: """Diese Aufwertungskarte hat variable Punktekosten.%LINEBREAK%<i>Fügt %BARRELROLL% hinzu</i>%LINEBREAK%<i>Benötigt <r>%BARRELROLL%</r></i>"""
        "Ezra Bridger":
           display_name: """Ezra Bridger"""
        ...
        "Hull Upgrade":
           ...
           text: """Diese Aufwertungskarte hat variable Punktekosten."""
        "IG-88D":
           display_name: """IG-88D"""
        ...
        "Tactical Officer":
           ...
           text: """<i>Fügt %COORDINATE% hinzu</i>%LINEBREAK%<i>Benötigt <r>%COORDINATE%</r></i>"""
        "Tactical Scrambler":
